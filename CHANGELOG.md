...
- Refined Prone / Unconscious / Wake-Up messaging to clearly distinguish:
  - Automatic mode = factual wording (falls, loses, dies)
  - Chat Prompt mode = conditional wording (may fall, may lose)
- Death handling is now based on Critical Wounds exceeding Toughness Bonus, with GM-controlled outcomes when enabled.
...
- Improved stability of round-based checks and token resolution during combat.
